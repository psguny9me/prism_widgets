...
/// Painter for the Diamond Prism (Material) effect.
class DiamondPrismPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant DiamondPrismPainter oldDelegate) {
